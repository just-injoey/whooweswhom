...
urlpatterns = [
    ...
    path('rooms_listNewRoom/',views.room_listNewRoom,name="room_listNewRoom"),
    path('rooms_detail/<int:pk>',views.room_details,name="room_detail"),
    path('rooms_detailTransaction/<int:pk>',views.room_detailTransaction,name="room_detailTransaction"),
    ...
    path('my_debtsSettleDebts/<int:pk>',views.my_debtsSettleDebts,name="my_debtsSettleDebts"),
    # path('my_debtsSettleDebts/',views.my_debtsSettleDebts,name="my_debtsSettleDebts"),
    ...
    path('join_us/',views.joinus,name="joinus2"),
]
